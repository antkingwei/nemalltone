...
public class SlidingMenu extends RelativeLayout {
    ...
    public void setCenterView(View view) {
        ...
        bgShadeContent.setBackgroundResource(R.color.half_white);
    ...
    public void showTopView() {
        ...
        int oldScrollY = mSlidingView.getScrollY();
        Log.e("antking", oldScrollY+"");
        if (oldScrollY == 0) {
            mMenuView.setVisibility(View.INVISIBLE);
            mDetailView.setVisibility(View.VISIBLE);
            smoothScrollToY(-menuHeight);
            tCanSlideLeft = canSlideLeft;
            tCanSlideRight = canSlideRight;
            hasClickRight = true;
            setCanSliding(false, true);
